...
interface PlayerData<T = any> {
  ...
  data: T;
  name?: string;
  channel: "finish-round" | "round-timeout" | "enter-room" | "set-name" | "chat-message" | "set-ready" | "game-start" | "enter-game";
}
...
interface ServerData<T = any> {
  channel: "result-round" | "next-round" | "end-game" | "round-timeout" | "players-in-room" | "chat-message" | "game-start" | "remove-player" | "game-start" | "player-in-game";
  data: T;
}
...
type MessageStatus = "round-score" | "start" | "loading" | "offline" | "timeout" | "not-found" | "not-ready"
}